...
|---|---|---|---|---|---|---|---|
| EGARCH(1,1,1) / — / — | 1 | 36.9259 | 0.0000 | 298724668.4953 | 0.0000 | -3965.7624 | 0.0000 |
| ESN-210 / — / — | 1 | 0.3335 | 0.0000 | 0.0581 | 0.0000 | 0.6764 | 0.0000 |
| ESN-500 / — / — | 1 | 0.3666 | 0.0000 | 0.0690 | 0.0000 | 0.6091 | 0.0000 |
| GARCH(1,1) / — / — | 1 | 4.5988 | 0.0000 | 137.0708 | 0.0000 | -60.5255 | 0.0000 |
| HAR-Ridge / — / — | 1 | 0.3148 | 0.0000 | 0.0537 | 0.0000 | 0.7118 | 0.0000 |
...
| OnionQRC / N=20 / ring | 3 | 0.3487 | 0.0021 | 0.0599 | 0.0005 | 0.6462 | 0.0042 |
...
| Persistence / — / — | 1 | 0.3320 | 0.0000 | 0.0586 | 0.0000 | 0.6794 | 0.0000 |
| RandomFeatureRidge-210 / — / — | 1 | 0.3607 | 0.0000 | 0.0635 | 0.0000 | 0.6216 | 0.0000 |
...
|---|---|---|---|---|---|---|
| EGARCH(1,1,1) / — / — | 298724668.4953 | 0.0537 | 2.155 | 0.0312 | ❌ No | ✅ Yes |
...
| OnionQRC / N=20 / ring | 0.0592 | 0.0537 | 2.127 | 0.0334 | ❌ No | ✅ Yes |
...
|---|---|---|---|---|---|---|
| EGARCH(1,1,1) / — / — | -5.401 | 0.000 | 0.0000 | 0.0000 | 0.0000 | ❌ |
| ESN-210 / — / — | 0.174 | 1.041 | 0.4492 | 0.3388 | 0.0528 | ✅ |
| ESN-500 / — / — | 0.052 | 1.025 | 0.8425 | 0.6002 | 0.0015 | ❌ |
| GARCH(1,1) / — / — | -8.031 | -0.266 | 0.0000 | 0.0000 | 0.0000 | ❌ |
| HAR-Ridge / — / — | 0.167 | 1.034 | 0.4397 | 0.3843 | 0.3838 | ✅ |
| LSTM / — / — | 2851.208 | 559.508 | 0.0000 | 0.0000 | 0.0000 | ❌ |
| OnionQRC / N=10 / fully_connected | 1.297 | 1.268 | 0.0000 | 0.0000 | 0.0000 | ❌ |
| OnionQRC / N=10 / ring | 1.430 | 1.296 | 0.0000 | 0.0000 | 0.0000 | ❌ |
| OnionQRC / N=15 / ring | 1.164 | 1.240 | 0.0000 | 0.0000 | 0.0000 | ❌ |
| OnionQRC / N=20 / ring | 1.167 | 1.241 | 0.0000 | 0.0000 | 0.0000 | ❌ |
| OnionQRC / N=5 / fully_connected | 1.544 | 1.323 | 0.0000 | 0.0000 | 0.0000 | ❌ |
| OnionQRC / N=5 / ring | 1.481 | 1.310 | 0.0000 | 0.0000 | 0.0000 | ❌ |
| Persistence / — / — | -0.844 | 0.843 | 0.0000 | 0.0000 | 0.0000 | ❌ |
| RandomFeatureRidge-210 / — / — | 0.840 | 1.182 | 0.0011 | 0.0002 | 0.0000 | ❌ |
